...
public class StudentDrawer extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void setContentView(View view) {
        drawerLayout = (DrawerLayout) getLayoutInflater().inflate(R.layout.nav_drawer_student, null);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.homeworks:
                ...
                finish();
                break;
            case R.id.missed_homework:
                startActivity(new Intent(getApplicationContext(), MissedHomeworks.class));
                overridePendingTransition(0, 0);
                finish();
                break;
            case R.id.pending_homework:
                startActivity(new Intent(getApplicationContext(), PendingHomeworks.class));
                overridePendingTransition(0, 0);
                finish();
                break;
            case R.id.completed_homework:
                startActivity(new Intent(getApplicationContext(), CompletedHomeworks.class));
                finish();
                break;
            case R.id.share:
